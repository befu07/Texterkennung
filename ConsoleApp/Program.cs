    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (OcrInput input = new OcrInput())
            {
                ...
                Bitmap? croppedImage = bitmap.Clone(contentArea, pixelformat);
                ...
                croppedImage.Save(@"_crop.png", ImageFormat.Png);
                #endregion

                input.AddImage(croppedImage);
                croppedImage.Dispose(); // Wird das Bild nicht mehr benötigt, .Dispose() aufrufen, damit RAM frei wird
